...
for (i = 0; i <  fiftyhrd_number; i++) {
    ...
    imgEl_1.onload = (e) => {
        ...
        if (arr_two.length <= 5) {
            ...
            image.animate('left', (Math.round(188* sRSS)) +(Math.round(10 * sRSS))+ (maxWidthblue * fiftyhuncount) + (Math.round(fiftyhunlittlemove * sRSS)), {
                duration: 800 + s_1,
                onChange: canvas.renderAll.bind(canvas),
...
for (i = 0; i < hrd_number; i++) {
    ...
    imgEl_1.onload = (e) => {
        ...
        if (arr_three.length <= 5) {
            ...
            image.animate('left', (Math.round(305 * sRSS))+(Math.round(20 * sRSS)) + (maxWidthyellow * huncount) + (Math.round(hunlittlemove * sRSS)), {
                duration: 800 + s_1,
                onChange: canvas.renderAll.bind(canvas),
            ...
            image.animate('left', (Math.round(345 * sRSS))+(Math.round(20 * sRSS)) + (maxWidthyellow * huncount) + (Math.round(hunlittlemove * sRSS)), {
                duration: 800 + s_1,
                onChange: canvas.renderAll.bind(canvas),
